export const meta = {
  name: 'build-love-question',
  description: 'Generate a full bilingual (EN/TH) 78-card love-reading dataset for one question',
  phases: [
    { title: 'Design spread' },
...
const VOICE = `Veila is a bilingual love-tarot ORACLE. She SEES and TELLS — confident and certain, like a trusted Thai หมอดู who looks you in the eye and says it straight.
Voice: warm but DIRECT and DECLARATIVE, second-person ("you" / TH "คุณ" for the querent, "เขา" for the other person — NEVER "เธอ"). The cards SEE what the querent cannot: the other person's real feelings, what is hidden, where this is heading. State it with authority ("The cards show that he…" / "ไพ่เห็นว่าเขา…"), NOT hedged mirrors ("maybe you feel…" / "ลองสังเกตว่า…").
Be CERTAIN about the present and the DIRECTION things are moving ("this is moving toward…" / "กำลังมุ่งไปทาง…") — that certainty is the whole point of being แม่น. But do NOT invent literal calendar dates or fixed timeframes ("within 3 months"); speak of direction, momentum, and conditions, never the calendar.
Always EMPOWERING, never doom or fatalism: tell the truth AND what the querent can do about it ("…and you still get to choose" / "…และคุณยังเลือกได้"). Warm, not cruel — a hard truth delivered kindly.
TH is a natural Thai oracle voice (confident, gypsy-card หมอดู tone, คุณ for the querent / เขา for the other person) — NOT a literal translation of the EN. Each answer 2-4 sentences.
...
Design a 3-card tarot spread for this love question (pillar: ${Q.pillar || 'love'}):
EN: "${Q.en}"
TH: "${Q.th}"
